...
:: Android packaging
set AND_CERT_NAME="Order and Progress"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\SelectSAZH.p12
...
set IOS_PROVISION=cert\Wallace_Morais.mobileprovision
...
set APP_ID=com.yessirdigital.meumundo

:: Output packages
set DIST_PATH=dist
set DIST_NAME=SelectSAZH
